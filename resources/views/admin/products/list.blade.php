...
<a class="btn btn-warning float-right mb-3"href="{{url('admin/products/create')}}">add new product</a>
@if($products->isEmpty())
        ...
        <tbody>
            ...
            <tr>
                ...
                <td  class="align-middle">
                    <a href="{{url('admin/products/' . $product->id . '/edit')}}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
